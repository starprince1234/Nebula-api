...
const (
	// Label holds the string label denoting the maintenancestate type in the database.
	...
	// Table holds the table name of the maintenancestate in the database.
	Table = "maintenance_state"
)

// Columns holds all SQL columns for maintenancestate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the MaintenanceState queries.
