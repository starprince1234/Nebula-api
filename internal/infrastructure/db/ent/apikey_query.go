...
type APIKeyQuery struct {
	...
	withModels        *APIKeyModelQuery
	withAudits        *APIKeyAuditQuery
	withCreditBuckets *APIKeyMonthCreditBucketQuery
...
func (_q *APIKeyQuery) QueryModels() *APIKeyModelQuery {
	query := (&APIKeyModelClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *APIKeyQuery) QueryAudits() *APIKeyAuditQuery {
...
func (_q *APIKeyQuery) QueryCreditBuckets() *APIKeyMonthCreditBucketQuery {
...
func (_q *APIKeyQuery) WithModels(opts ...func(*APIKeyModelQuery)) *APIKeyQuery {
	query := (&APIKeyModelClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *APIKeyQuery) WithAudits(opts ...func(*APIKeyAuditQuery)) *APIKeyQuery {
	query := (&APIKeyAuditClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *APIKeyQuery) WithCreditBuckets(opts ...func(*APIKeyMonthCreditBucketQuery)) *APIKeyQuery {
	query := (&APIKeyMonthCreditBucketClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *APIKeyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*APIKey, error) {
	...
	if query := _q.withModels; query != nil {
		if err := _q.loadModels(ctx, query, nodes,
			func(n *APIKey) { n.Edges.Models = []*APIKeyModel{} },
			func(n *APIKey, e *APIKeyModel) { n.Edges.Models = append(n.Edges.Models, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAudits; query != nil {
		if err := _q.loadAudits(ctx, query, nodes,
			func(n *APIKey) { n.Edges.Audits = []*APIKeyAudit{} },
			func(n *APIKey, e *APIKeyAudit) { n.Edges.Audits = append(n.Edges.Audits, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCreditBuckets; query != nil {
		if err := _q.loadCreditBuckets(ctx, query, nodes,
			func(n *APIKey) { n.Edges.CreditBuckets = []*APIKeyMonthCreditBucket{} },
			func(n *APIKey, e *APIKeyMonthCreditBucket) { n.Edges.CreditBuckets = append(n.Edges.CreditBuckets, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *APIKeyQuery) loadModels(ctx context.Context, query *APIKeyModelQuery, nodes []*APIKey, init func(*APIKey), assign func(*APIKey, *APIKeyModel)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apikeymodel.FieldAPIKeyID)
	}
	query.Where(predicate.APIKeyModel(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(apikey.ModelsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *APIKeyQuery) loadAudits(ctx context.Context, query *APIKeyAuditQuery, nodes []*APIKey, init func(*APIKey), assign func(*APIKey, *APIKeyAudit)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*APIKey)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apikeyaudit.FieldAPIKeyID)
	}
	query.Where(predicate.APIKeyAudit(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(apikey.AuditsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *APIKeyQuery) loadCreditBuckets(ctx context.Context, query *APIKeyMonthCreditBucketQuery, nodes []*APIKey, init func(*APIKey), assign func(*APIKey, *APIKeyMonthCreditBucket)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*APIKey)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apikeymonthcreditbucket.FieldAPIKeyID)
	}
	query.Where(predicate.APIKeyMonthCreditBucket(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(apikey.CreditBucketsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *APIKeyQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withOwner != nil {
			_spec.Node.AddColumnOnce(apikey.FieldOwnerUserID)
		}
