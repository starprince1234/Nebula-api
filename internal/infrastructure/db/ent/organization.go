...
func (e OrganizationEdges) MembershipsOrErr() ([]*OrganizationMember, error) {
	if e.loadedTypes[0] {
...
func (*Organization) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case organization.FieldName, organization.FieldDescription, organization.FieldStatus:
...
func (_m *Organization) QueryMemberships() *OrganizationMemberQuery {
