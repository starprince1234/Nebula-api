...
func (_q *OrganizationQuery) QueryMemberships() *OrganizationMemberQuery {
...
func (_q *OrganizationQuery) WithMemberships(opts ...func(*OrganizationMemberQuery)) *OrganizationQuery {
	query := (&OrganizationMemberClient{config: _q.config}).Query()
...
func (_q *OrganizationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Organization, error) {
	...
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *Organization) { n.Edges.Memberships = []*OrganizationMember{} },
			func(n *Organization, e *OrganizationMember) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *OrganizationQuery) loadMemberships(ctx context.Context, query *OrganizationMemberQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *OrganizationMember)) error {
