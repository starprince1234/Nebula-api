...
import type { ApiKey, Model, ModelResolution, Organization, Project, SubmitApiKey } from './types'
export const studentAPI = {
  ...
  resolveModel: (modelId: string) => get<ModelResolution>(`/api/v1/student/models/resolve?${new URLSearchParams({ model_id: modelId })}`),
